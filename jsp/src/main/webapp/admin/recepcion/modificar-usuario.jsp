...
<html>
    ...
    <body data-bs-theme="dark" >
        ...
        <section class="container mt-3">
            ...
            <form method="POST" action="${pageContext.request.contextPath}/admin/recepcion/modificar" id="formModificarUsuario">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" required name="password" value="<%=usuarioR.getPassword()%>" class="form-control" id="password" aria-describedby="password">
                </div>
                <div class="mb-3">
